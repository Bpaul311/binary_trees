 ...
 *
 * Description: This function takes two nodes in a binary tree
 * and finds their lowest common ancestor.
 * The lowest common ancestor is the deepest node that
 * has both given nodes as descendants. If either
 * of the nodes is NULL or there is no common ancestor,
